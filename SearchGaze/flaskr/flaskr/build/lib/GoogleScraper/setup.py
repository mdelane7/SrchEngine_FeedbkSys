...
version = re.search(
    "^__version__\s*=\s*'(.*)'",
    open("/Users/vrawat279/git/Search-Gaze 1/flaskr/flaskr/GoogleScraper/GoogleScraper/version.py").read(),
    re.M).group(1)

requirements = [r for r in open('/Users/vrawat279/git/Search-Gaze 1/flaskr/flaskr/GoogleScraper/requirements.txt', 'r').read().split('\n') if r]
...
setup(name='GoogleScraper',
      ...
      long_description=open('/Users/vrawat279/git/Search-Gaze 1/flaskr/flaskr/GoogleScraper/README.md').read(),
